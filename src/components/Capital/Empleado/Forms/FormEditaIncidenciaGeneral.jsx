...
const FormEditaIncidenciaGeneral = ({ incidencia, setIncidencias, setIncidenciasPagination }) => {
    ...
    const onActualizarIncidencia = async (values) => {
        setLoading(true)
        try {
            const { data } = await toast.promise(axios.patch(`/capital/incidencias/general/${incidencia.id_incidencia_general}`, values), {
...
export default FormEditaIncidenciaGeneral